...
import day44_Abstraction_InterfaceIntro.animalTask.Animal;
import day44_Abstraction_InterfaceIntro.animalTask.Cat;
import day44_Abstraction_InterfaceIntro.animalTask.Dog;
import day44_Abstraction_InterfaceIntro.animalTask.Playable;
...
public class PolymorphismIntro {
    ...
    public static void main(String[] args) {
       ...
       */
        ...
        Employee employee = new Teacher("Ali",30,'M',42,"SDET",145000.00);
        employee.work();
        // employee.bugReport();
        ...
        Playable animal12 = new Dog("Max", "Husky", 'M', 3, "Small", "White");
        System.out.println(animal12.isFriendly);
        animal12.play();
        //  animal2.drink();
        //  animal2.eat();

        Animal animal13 = new Cat("Max", "Husky", 'M', 3, "Small", "White");
