...
public class CydeoStudent {
    ...
    public CydeoStudent(String name, char gender, int age, int batcNumber, int groupNumber, String fieldOfStudy) {
        this.name = name;
        this.gender = gender;
        this.age = age;
    ...
    public void attendClass(){
        System.out.println(name + "is attengind class. ");
    }
