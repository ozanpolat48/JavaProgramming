...
public class UnaryOperators {
   ...
   int num2 = -25;
        ...
        --a; //pre decrement: decreases tha value by 1 right away
        ...
        System.out.println(c++); // post incremnet: first passes the current value, then increases the value by 1
        ...
        System.out.println( --x ); //pre decrement: decreases tha value by 1 right away
