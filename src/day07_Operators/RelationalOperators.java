...
public class RelationalOperators {
    ...
    public static void main(String[] args) {
        ...
        boolean isElingleForloan = creditScore >= 720; //if the credit score is 720 or greater, then it's eligible for the loan

        System.out.println("isElingleForloan = " + isElingleForloan);
