...
public class MyOfters {

    public static void main(String[] args) {


        Offer offer1 = new Offer();
        offer1.setInfo("WA", "Amazon Inc", "SDET", 110000, true, true, true, true);
        ...
        fullTimeOffers.removeIf( p -> !p.isFullTime ); // removes the offer is the offer is NOT fulltime
