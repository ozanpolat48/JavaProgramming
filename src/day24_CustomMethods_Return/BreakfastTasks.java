...
public class BreakfastTasks {
    ...
    public static void domain(String email){  //Cydeo.Scholl@gmail.com
    ...
    //3. Create amethod that can display the name of the month based on the given number to the method
    public static void nameOfMonth(int number) { //98
